...
export default function TaskDetailPage() {
  ...
  if (state.loading) return <StatusView type="loading" title="Opening task" message="Loading the task details…" />
  const task = state.tasks.find((item) => item.id === id)
  if (!task) return <StatusView type="empty" title="Task not found" message="This task may have been deleted, or the link may be incorrect." />
