...
export default function TaskForm({ onSubmit, saving }) {
  ...
  return (
    <form className="task-form" onSubmit={submit} noValidate>
      ...
      <div className="form-grid">
        ...
        <label>Due date <em>*</em><input type="date" name="dueDate" value={values.dueDate} onChange={update} aria-invalid={Boolean(errors.dueDate)} />{errors.dueDate && <small>{errors.dueDate}</small>}</label>
      </div>
